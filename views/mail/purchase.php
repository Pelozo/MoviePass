  ...
  <thead>
    <tr>
          ...
          <th class="col-2" align="left" valign="top" style="line-height: 24px; font-size: 16px; min-height: 1px; padding-right: 15px; padding-left: 15px; font-weight: normal; width: 16.666667%; margin: 0;">
              ...
              <img width="32px" src="https://raw.githubusercontent.com/Pelozo/MoviePass/master/views/logo/icon.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
          
</th>
          
          <th class="col-9 text-center" align="left" valign="top" style="line-height: 24px; font-size: 16px; min-height: 1px; padding-right: 15px; padding-left: 15px; font-weight: normal; width: 75%; margin: 0;">
  
            Felicitaciones por tu compra para <?=$movie;?>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>   
                  <h1 style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="left">Tus entradas:</h1>
                  <table id="showTable" class="table table-bordered" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%; border: 1px solid #dee2e6;">
                    <col style="width: 10%;">
                    <col style="width: 20%;">
                    <col style="width: 10%;">
                    <col style="width: 10%;">
                    <thead>
                      <tr>
                        <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">Fecha</th>
                        <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">Pelicula</th>
                        <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">Cine</th>
                        <th style="line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border-color: #dee2e6; border-style: solid; border-width: 1px 1px 2px;" align="left" valign="top">QR</th>
                   	 </tr>
                  </thead>
                  <tbody>
                      ...
                      <?php foreach($tickets as $ticket){?>
                        <tr>
                      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top"><?=$ticket->getPurchase()->getShow()->getDatetime();?></td>
                      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top"><?=$ticket->getPurchase()->getShow()->getMovie()->getTitle();?></td>
                      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top"><?=$ticket->getPurchase()->getShow()->getRoom()->getCinema()->getName();?></td>
                      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 12px; border: 1px solid #dee2e6;" align="left" valign="top"><img src="<?=$ticket->getQr();?>" width="200px"></td>
                      </tr> 
                      <?php } ?>
